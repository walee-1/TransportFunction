...
If[BackScatterBoole,
 ...
 wmomGenPiecePrime[a,p,wf,pmin2,ppmax2]*Sin[th0]*(1-bsFuncElectron2Compiled[p, th0, rD])*(*Change the backscattering description correctly*)
 ...
 wmomGenPiecePrime[a,p,wf,pmin2,ppmax2]*Sin[th0]*
  ...
  Piecewise[
   {
    ...
    {Which[#<pmin2,pmin2,#>ppmax2,ppmax2,True,#]&/@pmin, Length[pmin] <= 2}
    },
  ...
  Piecewise[
   {
    ...
    {Which[#<pmin2,pmin2,#>ppmax2,ppmax2,True,#]&/@ppmaxx, Length[ppmaxx] <= 2}(*,
    {	
