...
TEMPLATEFILE="Transfer_08-09-20_NC_opt_basis_d"$PARAMETER".m"
...
FOLDER="NC_Prot_opt_d"$PARAMETER
...
writer_Function(){
    ...
    sed -i "s+^Export.*$+Export[\"MergerTransport/NC_Prot_opt_d$PARAMETER/a\"<>ToString[IntegerPart[a*10000]]<>\"/TransferResult_08-09-20_NC_opt_$option\_d$PARAMETER\_a\"<>ToString[IntegerPart[a*10000]]<>\"_\"<>ToString[Bins[[1]]]<>\"-\"<>ToString[Bins[[2]]]<>\".txt\",BinwYShiftPrec44OriginalBinsb0NewBGrad,\"Table\"];+" $LOCALFILE
