...
fitFunc[en_, 
  th_] := (1 - 
    0.41751426576737466 E^(-0.1169720790756993 th^2)) \
(0.025903123294076517 - 0.0008146701231968558 en)/100;
...
If[BackScatterBoole,
 ...
 pmomNormed[p,a]*Sin[th0]*(1-fitFunc[TofP[pacc[p, -15000]]/1000, thDetAcc[p, th0, rD, -15000]*180/Pi]-0.02/100)*(*Change the backscattering description correctly*)
