...
ManualphiAIntegrandAllLimitsShift[
	...
	Block[
  		{
  			phimin = Re[phiAminApertShift[yD, xD, If[p==0.,1*10^-15,p], th0, alpha, BRxB, rRxB, rA, rD, phiDet, G1, G2, xOff, xAA, {XAShift, YRxBShift, XDetShift, YDetShift}]],
  			phimax = Re[phiAmaxApertShift[yD, xD, If[p==0.,1*10^-15,p], th0, alpha, BRxB, rRxB, rA, rD, phiDet, G1, G2, xOff, xAA, {XAShift, YRxBShift, XDetShift, YDetShift}]], 
  			phiminY = Re[phiAminApertfromYShift[yD, If[p==0.,1*10^-15,p], alpha, th0, BRxB, rRxB, rA, rD, phiDet, yOff, yAA, YAShift, YDetShift]], 
  			phimaxY = Re[phiAmaxApertfromYShift[yD, If[p==0.,1*10^-15,p], alpha, th0, BRxB, rRxB, rA, rD, phiDet, yOff, yAA, YAShift, YDetShift]],
