...
enDepCons={{0.5, 0.201041, 6.0343*10^-7}, {1, 0.192738, 8.15596*10^-7}, {5, 
  0.154989, 1.26596*10^-6}, {11, 0.147544, 1.30207*10^-6}, {21, 
  0.143927, 1.33762*10^-6}, {31, 0.138049, 1.32817*10^-6}, {41, 
  0.109545, 1.25526*10^-6}, {61, 0.0995411, 1.20289*10^-6}, {121, 
  0.0874904, 1.12997*10^-6}, {181, 0.0804435, 1.0644*10^-6}, {241, 
  0.075033, 1.04179*10^-6}, {301, 0.0714814, 9.93267*10^-7}, {361, 
  0.0720994, 9.083*10^-7}, {421, 0.0640258, 9.8262*10^-7}, {481, 
  0.0578074, 9.65853*10^-7}, {541, 0.0491098, 9.44137*10^-7}, {601, 
  0.0410172, 8.99075*10^-7}, {661, 0.0339246, 8.14732*10^-7}, {721, 
  0.0278361, 7.25737*10^-7}}
  
t2 = Interpolation[
  Transpose[{enDepCons[[All, 1]], enDepCons[[All, 3]]}], InterpolationOrder -> 1];
t1 = Interpolation[
  Transpose[{enDepCons[[All, 1]], enDepCons[[All, 2]]}], InterpolationOrder -> 1];
  
compc1 = With[{}, Compile[{{x, _Real}}, Evaluate[N[t1[x]]], 
   CompilationTarget -> "C", "RuntimeOptions" -> "Speed", 
   RuntimeAttributes -> {Listable}, 
   CompilationOptions -> {"InlineExternalDefinitions" -> True}]];
compc2 = With[{}, Compile[{{x, _Real}}, Evaluate[N[t2[x]]], 
   CompilationTarget -> "C", "RuntimeOptions" -> "Speed", 
   RuntimeAttributes -> {Listable}, 
   CompilationOptions -> {"InlineExternalDefinitions" -> True}]];  
...
If[BackScatterBoole,
 ...
 wmomNormedWb[\[Lambda]0, \[Kappa]0, b, p]*Sin[th0]*(1-bsFunc[Tofpe[p]/1000, theta2[th0,rD]/Pi*180.])*
