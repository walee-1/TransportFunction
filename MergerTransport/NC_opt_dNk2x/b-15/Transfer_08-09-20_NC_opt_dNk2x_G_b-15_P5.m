 ...
 ParallelMap[
  AbsoluteTiming[
    BinIntShift[
     ...
     {0.06, 0.059, 0.9, 0.005, -0.9, 0.1, 0.099, 0.9, 0., -0.9}, {ApertX, ApertY, ApertXOff, ApertYOff},
     {IntMethod, 4, 2, 0, 2}, {IntMethod, 4, 2, 0, 2}, {IntMethod, 3, 6, 0, 1}
     ]] &, XYBinBoundariesYHalf[[Bins[[1]] ;; Bins[[2]]]], 
  Method -> "FinestGrained"];

Export["MergerTransport/NC_opt_dNk2x/b"<>ToString[IntegerPart[b*10000]]<>"/TransferResult_08-09-20_NC_opt_G_BSOn_dNk2x_b"<>ToString[IntegerPart[b*10000]]<>"_"<>ToString[Bins[[1]]]<>"-"<>ToString[Bins[[2]]]<>".txt",BinwYShiftPrec44OriginalBinsb0NewBGrad,"Table"];
