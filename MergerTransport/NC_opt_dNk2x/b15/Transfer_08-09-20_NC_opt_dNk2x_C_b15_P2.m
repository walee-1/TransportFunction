...
Export["MergerTransport/NC_opt_dNk2x/b"<>ToString[IntegerPart[b*10000]]<>"/TransferResult_08-09-20_NC_opt_C_BSOn_dNk2x_b"<>ToString[IntegerPart[b*10000]]<>"_"<>ToString[Bins[[1]]]<>"-"<>ToString[Bins[[2]]]<>".txt",BinwYShiftPrec44OriginalBinsb0NewBGrad,"Table"];
