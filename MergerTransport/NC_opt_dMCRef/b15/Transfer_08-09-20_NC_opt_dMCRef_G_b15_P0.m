...
t0=AbsoluteTime[];
SetDirectory["C:/Users/smi/Desktop/DanielFits/Transport_24-09-20"];
...
XAShift = 0.0;YAShift = 0.007192;YRxBShift = 0.00677284727516161`-0.000778/2;YDetShift = 0.015928000000000164`-0.000779;
 ...
 ParallelMap[
  AbsoluteTiming[
    BinIntShift[
     ...
     {0.1, 0.099, 0.99, 0., -0.99, 0.1, 0.099, 0.99, 0., -0.99}, {ApertX, ApertY, ApertXOff, ApertYOff},
     {IntMethod, 4, 2, 0, 3}, {IntMethod, 4, 2, 0, 2}, {IntMethod, 3, 6, 0, 1}
     ]] &, XYBinBoundariesYHalf[[Bins[[1]] ;; Bins[[2]]]], 
  Method -> "FinestGrained"];

Export["MergerTransport/NC_opt_dMCRef/b"<>ToString[IntegerPart[b*10000]]<>"/TransferResult_08-09-20_NC_opt_G_BSOn_dMCRef_b"<>ToString[IntegerPart[b*10000]]<>"_"<>ToString[Bins[[1]]]<>"-"<>ToString[Bins[[2]]]<>".txt",BinwYShiftPrec44OriginalBinsb0NewBGrad,"Table"];
