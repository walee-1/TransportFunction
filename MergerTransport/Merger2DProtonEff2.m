...
fitFunc[en_, 
  th_] := (1 - 0.284142 E^(-0.0858325 th^2)) (0.0459008 + 0.000469211 en);
...
If[BackScatterBoole,
 ...
 pmomNormed[p,a]*Sin[th0]*(1-fitFunc[TofP[pacc[p, -15000]]/1000, thDetAcc[p, th0, rD, -15000]*180/Pi])*(*Change the backscattering description correctly*)
