...
Export["MergerTransport/SC_Prot_diffRatio_drD2/a"<>ToString[IntegerPart[a*10000]]<>"/TransferResult_08-09-20_SC_diffRatio_C_drD2_a"<>ToString[IntegerPart[a*10000]]<>"_"<>ToString[Bins[[1]]]<>"-"<>ToString[Bins[[2]]]<>".txt",BinwYShiftPrec44OriginalBinsb0NewBGrad,"Table"];
