...
BinwYShiftPrec44OriginalBinsb0NewBGrad = 
 ParallelMap[
  AbsoluteTiming[
    BinIntShift[
     a, #, 
     {alphaSC, bRxBSC, rFSC, rRxBSC, rASC, rDSC, g1SC, g2SC}, {xAShiftSC+offset, yAShiftSC, yRxBShiftSC, xDShiftSC, yDShiftSC}, 
...
Export["MergerTransport/SC_Prot_opt_dXAShift_2D/a-1055_-15/TransferResult_08-09-20_SC_opt_H_dXAShift_a-1055_-15_"<>ToString[Bins[[1]]]<>"-"<>ToString[Bins[[2]]]<>".txt",BinwYShiftPrec44OriginalBinsb0NewBGrad,"Table"];
