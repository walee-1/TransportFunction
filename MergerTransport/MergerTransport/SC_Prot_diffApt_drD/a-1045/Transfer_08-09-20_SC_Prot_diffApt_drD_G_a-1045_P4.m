...
Export["MergerTransport/SC_Prot_diffApt_drD/a"<>ToString[IntegerPart[a*10000]]<>"/TransferResult_08-09-20_SC_diffApt_G_drD_a"<>ToString[IntegerPart[a*10000]]<>"_"<>ToString[Bins[[1]]]<>"-"<>ToString[Bins[[2]]]<>".txt",BinwYShiftPrec44OriginalBinsb0NewBGrad,"Table"];
