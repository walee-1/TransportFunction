...
Export["MergerTransport/SC_Prot_opt_dXAShift/a"<>StringSplit[ToString[a*10000], "."][[1]]<>"/TransferResult_08-09-20_SC_opt_D_dXAShift_a"<>ToString[IntegerPart[a*10000]]<>"_"<>ToString[Bins[[1]]]<>"-"<>ToString[Bins[[2]]]<>".txt",BinwYShiftPrec44OriginalBinsb0NewBGrad,"Table"];
