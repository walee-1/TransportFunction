...
Get["MergerTransport/Merger2D_Argh.m"];
...
xAOffSC=6.5/1000;
yAOffSC=0;
{wnxSC, pnxSC, kx1SC, kx2SC, kx3SC, wnySC, pnySC, ky1SC, ky2SC, ky3SC}={0.00, 0.000, 1, 0., -1, 0.00, 0.000, 1, 0., -1}

xStart=-0.0008;
xEnd=0.0012;
yStart=-0.041;
yEnd=0.041;
xyBins=bin2DGen[xStart,xEnd,yStart,yEnd,10,1];
