...
XYBinBoundariesYHalf = Flatten[Table[
    {
     ...
     }, {xi, 2, Length[DetHisto[[1]]] - 2, 1}, {yi, 1, 
     Length[DetHisto[[2]]] - 2, 2}], 1];
...
BinwYShiftPrec44OriginalBinsb0NewBGrad = 
 ParallelMap[
  AbsoluteTiming[
    BinIntShift[
     0.0, #, 
     {AlphaFromBlinesCorr, BfromCentralBline, rF, rRxB, rA, rDet, R, BlinefitG1, BlinefitG2}, {XAShift, YAShift, YRxBShift, XDetShift, YDetShift}, 
     ...
     ]] &, XYBinBoundariesYHalf[[1 ;; 64]], 
  Method -> "FinestGrained"];
  
Export["MergerTransport/TransferResult_18-08-20_b0_NC_DY_opt_Part1.txt",BinwYShiftPrec44OriginalBinsb0NewBGrad,"Table"];
