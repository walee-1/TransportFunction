...
t0=AbsoluteTime[];
SetDirectory["C:/Users/smi/Desktop/DanielFits/Transport_28-08-20"];
...
BinwYShiftPrec44OriginalBinsb0NewBGrad = 
 ParallelMap[
  AbsoluteTiming[
    BinIntShift[
     b, #, 
     {AlphaFromBlinesCorr+AlphaFromBlinesCorr*5*10^-5, BfromCentralBline, rF, rRxB, rA, rDet, R, BlinefitG1, BlinefitG2}, {XAShift, YAShift, YRxBShift, XDetShift, YDetShift}, 
     {0.1, 0.099, 0.9, 0., -0.9, 0.1, 0.099, 0.9, 0., -0.9}, {ApertX, ApertY, ApertXOff, ApertYOff},
     {IntMethod, 4, 3, 0, 2}, {IntMethod, 4, 3, 0, 2}, {IntMethod, 3, 3, 0, 1}
     ]] &, XYBinBoundariesYHalf[[Bins[[1]] ;; Bins[[2]]]], 
  Method -> "FinestGrained"];

Export["MergerTransport/NC_opt_dAlpha/b"<>ToString[IntegerPart[b*10000]]<>"/TransferResult_28-08-20_NC_opt_G_BSOn_dAlpha_b"<>ToString[IntegerPart[b*10000]]<>"_"<>ToString[Bins[[1]]]<>"-"<>ToString[Bins[[2]]]<>".txt",BinwYShiftPrec44OriginalBinsb0NewBGrad,"Table"];
