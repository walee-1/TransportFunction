...
Export["MergerTransport/NC_opt_dAlpha/b"<>ToString[IntegerPart[b*10000]]<>"/TransferResult_08-09-20_NC_opt_C_BSOn_dAlpha_b"<>ToString[IntegerPart[b*10000]]<>"_"<>ToString[Bins[[1]]]<>"-"<>ToString[Bins[[2]]]<>".txt",BinwYShiftPrec44OriginalBinsb0NewBGrad,"Table"];
