 ...
 ParallelMap[
  AbsoluteTiming[
    BinIntShift[
     ...
     {IntMethod, 5, 3, 0, 2}, {IntMethod, 4, 3, 0, 2}, {IntMethod, 3, 3, 0, 1}
     ]] &, XYBinBoundariesYHalf[[Bins[[1]] ;; Bins[[2]]]], 
  Method -> "FinestGrained"];

Export["MergerTransport/NC_opt_d0/b"<>ToString[IntegerPart[b*10000]]<>"/TransferResult_08-09-20_NC_opt_D_BSOn_d0Prec15_b"<>ToString[IntegerPart[b*10000]]<>"_"<>ToString[Bins[[1]]]<>"-"<>ToString[Bins[[2]]]<>".txt",BinwYShiftPrec44OriginalBinsb0NewBGrad,"Table"];
