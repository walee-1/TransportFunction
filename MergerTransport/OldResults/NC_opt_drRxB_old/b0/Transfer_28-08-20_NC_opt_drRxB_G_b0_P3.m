...
BinwYShiftPrec44OriginalBinsb0NewBGrad = 
 ParallelMap[
  AbsoluteTiming[
    BinIntShift[
     b, #, 
     {AlphaFromBlinesCorr, BfromCentralBline, rF, rRxB+rRxB*10^-4, rA, rDet, R, BlinefitG1, BlinefitG2}, {XAShift, YAShift, YRxBShift, XDetShift, YDetShift}, 
...
Export["MergerTransport/NC_opt_drRxB/b"<>ToString[IntegerPart[b*10000]]<>"/TransferResult_28-08-20_NC_opt_G_BSOn_drRxB_b"<>ToString[IntegerPart[b*10000]]<>"_"<>ToString[Bins[[1]]]<>"-"<>ToString[Bins[[2]]]<>".txt",BinwYShiftPrec44OriginalBinsb0NewBGrad,"Table"];
