...
Export["MergerTransport/SC_Prot_opt_drF/a"<>ToString[IntegerPart[a*10000]]<>"/TransferResult_08-09-20_SC_opt_H_drF_a"<>ToString[IntegerPart[a*10000]]<>"_"<>ToString[Bins[[1]]]<>"-"<>ToString[Bins[[2]]]<>".txt",BinwYShiftPrec44OriginalBinsb0NewBGrad,"Table"];
