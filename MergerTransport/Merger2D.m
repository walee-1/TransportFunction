...
If[BackScatterBoole,
 ...
 wmomNormedWb[\[Lambda]0, \[Kappa]0, b, p]*Sin[th0]*(1-bsFuncElectron2[p, th0, rD])*
...
ManualphiAIntegrandAllLimitsShift[
	...
	Module[
		...
		IntValues = Integrand2DwNBeamCompiledShiftRxBS[b, yD, xD, {phiDV, #, phiDet, p, th0}, {alpha, BRxB, rRxB, rA, rD, R, G1,G2}, 
