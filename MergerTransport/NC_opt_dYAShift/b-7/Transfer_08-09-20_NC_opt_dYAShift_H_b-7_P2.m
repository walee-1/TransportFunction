...
Export["MergerTransport/NC_opt_dYAShift/b"<>ToString[IntegerPart[b*10000]]<>"/TransferResult_08-09-20_NC_opt_H_BSOn_dYAShift_b"<>ToString[IntegerPart[b*10000]]<>"_"<>ToString[Bins[[1]]]<>"-"<>ToString[Bins[[2]]]<>".txt",BinwYShiftPrec44OriginalBinsb0NewBGrad,"Table"];
