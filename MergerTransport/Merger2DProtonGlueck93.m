...
If[BackScatterBoole,
	...
	lambda_, yD_, xD_, {phiDV_?NumericQ, phiA_?NumericQ, phiDet_?NumericQ, p_?NumericQ, th0_?NumericQ}, {alpha_, BRxB_, rRxB_, rA_,rD_, G1_, G2_},
 ...
 pmomNormedGlueck93[p,lambda,\[Kappa]0]*Sin[th0]*(1-bsFuncElectron2Compiled[p, th0, rD])*(*Change the backscattering description correctly*)
  
  TrapezNBeamCompiledNormed[
   DeltaxDV2Shift[phiDV, yD, xD, p, th0, alpha, BRxB, rRxB, rD, phiDet, G1, G2, {YRxBShift, XDetShift, YDetShift}]-xOff, {twx, plx, k1x, k2x, k3x}]*
  TrapezNBeamCompiledNormed[
   DeltayDVShift[phiDV, yD, p, alpha, th0, BRxB, rRxB, rD, phiDet, YDetShift]-yOff, {twy, ply,k1y, k2y, k3y}]*
 ...
 pmomNormedGlueck93[p,lambda,\[Kappa]0]*Sin[th0]*
...
ManualphiAIntegrandAllLimitsShift[
	lambda_, yD_, xD_, {phiDV_?NumericQ, phiDet_?NumericQ, p_?NumericQ, th0_?NumericQ}, 
	...
	Block[
		...
		IntValues = Integrand2DwNBeamCompiledShiftRxBS[lambda, yD, xD, {phiDV, #, phiDet, p, th0}, {alpha, BRxB, rRxB, rA, rD, G1,G2}, 
...
Step1IntShift[lambda_, yD_, xD_, {phiDet_?NumericQ, th0_?NumericQ}, 
	{alpha_, BRxB_, rRxB_, rA_, rD_, G1_, G2_},{XAShift_, YAShift_, YRxBShift_, XDetShift_, YDetShift_}, 
	{twx_, plx_, k1x_, k2x_, k3x_, twy_, ply_, k1y_, k2y_, k3y_}, {xAA_, yAA_, xOff_, yOff_},
	method1_,PrecGoal1_,AccGoal1_,MinRec1_,MaxRec1_]:=
	NIntegrate[
		ManualphiAIntegrandAllLimitsShift[lambda, yD, xD, {phiDV, phiDet, p, th0}, 
...
Step2IntShift[lambda_, xD_?NumericQ,yD_?NumericQ, {alpha_, BRxB_, rF_, rRxB_, rA_, rD_, G1_, G2_},{XAShift_, YAShift_, YRxBShift_, XDetShift_, YDetShift_}, 
	...
	{xAA_, yAA_, xOff_, yOff_}, method1_,PrecGoal1_,AccGoal1_,MinRec1_,MaxRec1_, method2_,PrecGoal2_,AccGoal2_,MinRec2_,MaxRec2_]:=
		...
		NIntegrate[
		Step1IntShift[lambda, yD, xD, {phiDet, th0}, 
...
BinIntShift[lambda_, OneBinList_, {alpha_, BRxB_, rF_, rRxB_, rA_, rD_, G1_, G2_},{XAShift_, YAShift_, YRxBShift_, XDetShift_, YDetShift_}, 
	{twx_, plx_, k1x_, k2x_, k3x_, twy_, ply_, k1y_, k2y_, k3y_},
	...
	NIntegrate[
		...
		Step2IntShift[lambda, xD, yD, {alpha, BRxB, rF, rRxB, rA, rD, G1, G2}, {XAShift, YAShift, YRxBShift, XDetShift, YDetShift}, 
			{twx, plx, k1x, k2x, k3x, twy, ply, k1y, k2y, k3y}, {xAA, yAA, xOff, yOff},
