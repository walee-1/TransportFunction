...
IntTableArithAlphaPrime[b_?NumericQ, {alpha_?NumericQ, BRxB_?NumericQ, rRxB_?NumericQ, rD_?NumericQ,rF_}, {xA_?NumericQ, yA_?NumericQ, xOff_?NumericQ, 
   ...
   Re[
    IntegrandArithAlphaPrime[b, {xD, p, th0, alpha, BRxB, rRxB, rD}, {xA, yA, xOff, yOff, x0, y0, rA},{R,AlphaTrans,zt}]
    	...
    	{x0, -xA/2 - rG[pmax, th0, BRxB], xA/2 + rG[pmax, th0, BRxB]},
...
IntegrandArithAddedAngleAlphaPrime[
  b_?NumericQ, {xi_?NumericQ, p_?NumericQ, th0_?NumericQ, alpha_?NumericQ, BRxB_?NumericQ, rRxB_?NumericQ, rD_?NumericQ}, {xA_?NumericQ, yA_?NumericQ, xOff_?NumericQ, 
   yOff_?NumericQ, x0_?NumericQ, y0_?NumericQ, rA_?NumericQ},{R_,AlphaTrans_,zt_,AddedScale_}] :=
    
    ArithApert[xA, yA, xOff, yOff, x0, y0, rG[ p,theta2[th0, rA], rA*BRxB/rRxB]]*
     wmomNormedWb[\[Lambda]0,\[Kappa]0,b, p]*
     Sin[th0]*
     WeightrG[xi - x0 + DSumAddedAngleAlpha[p,th0,alpha,BRxB,rRxB,{R,AlphaTrans,zt,AddedScale}], p, theta2[th0, rD], rD*BRxB/rRxB]/(xA + 2*rG[pmax, th0, rA*BRxB/rRxB])
...
pminFuncAddedAngleAlphaPrime[x0_, xD_, th0_, alpha_, rRxB_, BRxB_, 
 ...
 Solve[xD - x0 + 
     DSumAddedAngleAlpha[p,th0,alpha,BRxB,rRxB,{R,AlphaTrans,zt,AddedScale}] == -rG[p, theta2[th0, rD], rD*BRxB/rRxB], p][[1, 1, 2]]
...
pminAddedAngleAlphaPrimeCases[x0_, xD_, th0_, alpha_, rRxB_, BRxB_, rD_, {R_, AlphaTrans_, zt_}] := Which[
    pminFuncAddedAngleAlphaPrime[x0, xD, th0, alpha, rRxB, BRxB, rD, {R, AlphaTrans, zt}] > pmax, pmax,
   pminFuncAddedAngleAlphaPrime[x0, xD, th0, alpha, rRxB, BRxB, rD, {R, AlphaTrans, zt}] < 0, 0,
    True, pminFuncAddedAngleAlphaPrime[x0, xD, th0, alpha, rRxB, BRxB, rD, {R, AlphaTrans, zt}]
    ]
    
pmaxAddedAngleAlphaPrimeCases[x0_, xD_, th0_, alpha_, rRxB_, BRxB_, rD_, {R_, AlphaTrans_, zt_}] := Which[
    pmaxFuncAddedAngleAlphaPrime[x0, xD, th0, alpha, rRxB, BRxB, rD, {R, AlphaTrans, zt}] > pmax, pmax,
   pmaxFuncAddedAngleAlphaPrime[x0, xD, th0, alpha, rRxB, BRxB, rD, {R, AlphaTrans, zt}] < 0, 0,
    True, pmaxFuncAddedAngleAlphaPrime[x0, xD, th0, alpha, rRxB, BRxB, rD, {R, AlphaTrans, zt}]
    ]
