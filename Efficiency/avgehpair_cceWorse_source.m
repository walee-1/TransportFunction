...
If[FileExistsQ[resultDir<>"cceAdjustIonListEn"<>ToString[enTable[[en]]]<>"FineAllAngWorse.mx"],
ImsilPlgadDataEnAllAngIonList=Import[resultDir<>"cceAdjustIonListEn"<>ToString[enTable[[en]]]<>"FineAllAngWorse.mx"];,
Print["ERROR No File there, Please put the all ang list there"];Quit[]]




    Export[resultDir<>"avgEHpairHisto"<>ToString[enTable[[en]]]<>"AllAngWorse.mx",
