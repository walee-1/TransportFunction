...
showcolorfunction::usage="Shows the gradient color map of a color map
Usage: showcolorfunction@\"color map name\"
Example:
showcolorfunction[MPLColorMap[#]] & /@ {\"Magma\", \"Inferno\", \"Plasma\", \"Viridis\", \"EricsRdBuGnYl\", \"EricsRdBuGnYl2\", \"EricsPuBuGnYl\", \"FakeParula\", \"JoesBluGrnPnk2\"}
"
